...
/** Callback: called when the "AI助手" button is clicked */
typedef void (*home_nav_to_ai_chat_cb_t)(void);

/** Callback: called when the "传感器" button is clicked */
typedef void (*home_nav_to_sensor_cb_t)(void);
